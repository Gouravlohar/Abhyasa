        ...
        <div className="terminal-wrapper">
            <div className="terminal-top ">
                ...
                <div className="top-mid">
                    ...
                    <span className="">root@fAbhyasa:~/student/Quiz/Question_{questionCounter}</span>
                </div>
            ...
            <div id="terminal-wrapper" className="terminal-bot">
                <p className="terminal-prompt last-login">
                    -!- friend_ [friend_@10.3.2.169] has started quiz #Abhyasa.
                </p>
                {/* User score */}
                ...
                {/* Question */}
                <p className="mt-25 terminal-prompt"><span className="terminal-green">root@Abhyasa:~/student/Quiz/Question_{questionCounter}{">"}</span> {questions[currQuestion].question}</p>
                {/* Option A */}
                <div className="mt-10 terminal-prompt terminal-text terminal-start">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Question_{questionCounter}/Option_A{">"}</p>
                    <button id="btn-a" onClick={() => { setOptionChosen("a"); }} className="optionBtn option-transition">{questions[currQuestion].optionA}</button>
                </div>
                {/* Option B */}
                <div className="mt-10 terminal-prompt terminal-text terminal-start">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Question_{questionCounter}/Option_B{">"}</p>
                    <button id="btn-b" onClick={() => { setOptionChosen("b"); }} className="optionBtn option-transition">{questions[currQuestion].optionB}</button>
                </div>
                {/* Option C */}
                <div className="mt-10 terminal-prompt terminal-text terminal-start">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Question_{questionCounter}/Option_C{">"}</p>
                    <button id="btn-c" onClick={() => { setOptionChosen("c"); }} className="optionBtn option-transition">{questions[currQuestion].optionC}</button>
                </div>
                {/* Option D */}
                <div className="mt-10 terminal-prompt terminal-text terminal-start">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Question_{questionCounter}/Option_D{">"}</p>
                ...
                <div className="mt-10 terminal-prompt terminal-text terminal-start">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/{lastQuestion}{">"}</p>
                ...
                <div id="giveUp-section" className="mt-10 terminal-prompt terminal-text terminal-start fadeIn">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Give_Up{">"}</p>
                ...
                <div className="fadeIn delay-0_5 mt-10 terminal-prompt terminal-text terminal-start terminal-giveUp">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Give_Up/Yes{">"}</p>
                ...
                <div className="fadeIn delay-0_7 mt-10 terminal-prompt terminal-text terminal-start terminal-giveUp">
                    <p className="terminal-green">root@Abhyasa:~/student/Quiz/Give_Up/No{">"}</p>
